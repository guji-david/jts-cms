    ...
    <div class="z-search-box">
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="z-span-20">
              <el-form-item label="提现时间：" prop="queryDate">
                <el-date-picker
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTablelist () {
        API.$queryWithdraw(this.objFn(), res => {
          this.tableData = res.list
          this.totalCount = res.totalCount
        })
      },
      download () {
        API.$downloadFile('accountFlowQuery', '/gateway/tradeAccountFlow/queryWithdrawExport', this.objFn())
      }
    }
  }
</script>
