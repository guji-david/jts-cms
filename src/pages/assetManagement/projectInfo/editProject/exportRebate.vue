    ...
    <div id="z-edit">
      <el-form :model="formAlignRight" label-width="220px" :rules="rules" ref="formAlignRight">
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="借款方信息" name="1">
            ...
            <el-form-item label="借方名称：" prop="borrowerName">
              ...
              <el-select v-model="formAlignRight.borrowerName"@change="choice()" :disabled="borrowerNameDisabled"placeholder="请选择">
                <el-option
          ...
          <el-collapse-item title="项目信息" name="2">
            ...
            <el-form-item label="借款利率(%)：" prop="annualRate">
              <el-input v-model="formAlignRight.annualRate"></el-input>
            </el-form-item>
          ...
          <el-collapse-item title="项目描述" name="3">
            ...
            <el-form-item label="融资用途：" prop="usageOfLoan">
              <el-input
                type="textarea"
                :autosize="{ minRows: 2, maxRows: 4}"
                placeholder="请输入内容"
          ...
          <el-collapse-item title="保障措施" name="4">
            <el-form-item label="还款保障措施：" prop="repaymentGuaranteeMeasures">
              <el-input v-model="formAlignRight.repaymentGuaranteeMeasures"></el-input>
            </el-form-item>
            <el-form-item label="风控意见：" prop="riskManagementOpinion">
              <el-input v-model="formAlignRight.riskManagementOpinion"></el-input>
            </el-form-item>
            <el-form-item label="资料展示：">
              <el-row class="flexWrap">
                ...
                <div class="plusDiv">
                  <div class="div100px">
                    <el-button  icon="plus" class=""  @click="addpic(imgList[0].property)" type="primary">增加{{formatTitle(imgList[0].property)}}</el-button>
                  </div>
                </div>
              </el-row>
            </el-form-item>
        ...
        <el-form-item style="padding:20px 0px 50px 0px; text-align:center">
          <el-button type="primary" @click="submitForm('formAlignRight')" class='btn' :disabled="disabledStatus" v-loading.fullscreen.lock="loadingFull">保存数据</el-button>
