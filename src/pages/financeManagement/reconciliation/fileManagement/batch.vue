  ...
  export default {
    data () {
      return {
        ...
        pageSize: 5,
        test: '',
        disabledArray: []// 权限控制\1/查询,2/下载原文件,3/下载解密后文件
      }
    },
    ...
    methods: {
      ...
      handleCurrentChange (val) { // 这个是pageNo
        ...
        this.pageNo = val
        this.getTableList(this.pageSize, this.pageNo)
        console.log(`当前页: ${this.pageNo}+${this.currentPage}`)
      },
      // 查询
      searchForm () {
        this.pageNo = 1
      ...
      getTableList (pageSize, pageNo) {
        ...
        API.$pageQueryBRFNotify(obj, res => { //
      ...
      downLoadDec (id) {
        API.$downloadDec(id, '/gateway/logbank/downloadFileGetOneDecBRF')
      }
    }
  }
</script>
