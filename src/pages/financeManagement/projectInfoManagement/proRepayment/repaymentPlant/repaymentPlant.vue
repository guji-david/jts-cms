<template>
  <div id="content-body" class="content-body">
    ...
    <header class="header">
        <div v-for="(x,index) in headerData" @click="repaymentPlant(x.repayPlanDate,index)" :class="{active:active===index}">{{planDate[index]}}</div>
    </header>
    <main>
     <!-- <el-row class="m20">
     ...
     <!-- <el-row class="m20">
        ...
        <el-button @click="repaymentConfirm('1')" v-if="accountType == 1 || accountType == 'all'">内部户</el-button>
        <el-button @click="repaymentConfirm('2')" v-if="accountType == 2 || accountType == 'all'">保证金账户</el-button>
      </el-row>-->
      <el-row class="m20">
